...
class HillClimber:
    def __init__(self, experiment_constants, below_maps, exp_directory='.'):
    ...
    def initialize_population(self):
        ...
        while len(self.children_population) < self.target_population_size:
            ...
            for i in range(self.target_population_size):
                ...
                preliminary_pop[new_id] = Solution(layers=self.layers, id=new_id, below_map=self.below_maps[i])
