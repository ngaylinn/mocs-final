...
class HillClimber:
    def __init__(self, experiment_constants, above_maps, below_maps, exp_directory='.'):
        ...
        self.below_maps = below_maps
        self.above_maps = above_maps
    ...
    def evolve_one_generation(self):
        ...
        self.above_maps = np.array([sol.above_map for _, sol in self.children_population.items()])
        self.below_maps = np.array([sol.below_map for _, sol in self.children_population.items()])
    ...
    def initialize_population(self):
        ...
        while len(self.children_population) < self.target_population_size:
            ...
            for i in range(self.target_population_size):
                ...
                preliminary_pop[new_id] = Solution(layers=self.layers, id=new_id, above_map=self.above_maps[i], below_map=self.below_maps[i])
